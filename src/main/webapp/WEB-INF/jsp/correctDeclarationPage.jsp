...
<body>
<h2>Declaration correction page - to be implemented </h2><br>
...
<%--        </tr>--%>
<%--&lt;%&ndash;        <tr>&ndash;%&gt;--%>
<%--&lt;%&ndash;            <td><label for="personalTaxNumber"><fmt:message key="new.report.tax.number" />:</label></td>&ndash;%&gt;--%>
<%--&lt;%&ndash;            <td><input required type="number" id="personalTaxNumber" name="personalTaxNumber" value= ""/> </td>&ndash;%&gt;--%>
<%--&lt;%&ndash;        </tr> TODO&ndash;%&gt;--%>
<%--        <tr>--%>
...
<%--&lt;%&ndash;            <p>Simple value of taxCategory variable: <c:out value="${taxCategory}"/></p> TODO add browser calculation&ndash;%&gt;--%>
<%--&lt;%&ndash;            <p>Value of taxCategory variable via param: <c:out value="${param.taxCategory}"/></p>&ndash;%&gt;--%>
<%--&lt;%&ndash;            <c:set var="taxRate" value="${taxCategory eq 'prefrential' ? 0.9 : taxCategory eq 'employee' ? 0.8 : 0.7 }"/>&ndash;%&gt;--%>
<%--&lt;%&ndash;            <p>value of taxRate variable: <c:out value="${taxRate}"/></p>&ndash;%&gt;--%>
<%--&lt;%&ndash;            <p>value of expectedTax variable: <c:set var="expectedTax" value="${taxRate * income}"/></p>&ndash;%&gt;--%>
